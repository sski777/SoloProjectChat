  ...
  const handleSend = () => {
    if (message != '') {
      const options = {
        ...
        body: JSON.stringify({ id: user.sub, name: user.nickname, content: message })
      }
    ...
    <div className="flex flex-col h-screen bg-gray-100 p-6">
      ...
      <div className="flex justify-between items-center mb-4">
        ...
        <div className="flex items-center gap-4">
          <img src={user.picture} alt="Profile" className="w-10 h-10 rounded-full border-2 border-blue-400" />
    ...
    <div className="flex justify-between items-center">
      ...
      {msg.id === user.sub && (
        <button
          ...
          onClick={() => HandeDelete(msg.content)}
        >
          Delete
        </button>
      )}
